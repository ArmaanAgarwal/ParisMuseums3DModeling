...
interface TourStepLevel3Zone1Props {
  onNext: () => void;
  onPrevious: () => void;
}

export function TourStepLevel3Zone1({ onNext, onPrevious }: TourStepLevel3Zone1Props) {
      ...
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        ...
        >
            ...
            <div className="mx-auto max-w-4xl">
              ...
              <div className="grid gap-6 md:grid-cols-2">
                {featuredObjects.map((obj, i) => (
                  ...
                  >
                    <Link
                      href={`${getObjectHref(obj.id)}?fromTour=1&tourStep=level3-zone1`}
          ...
          <div className="mx-auto max-w-4xl flex gap-4">
            <Link
              href={`${getZoneHref(firstZone.id)}?fromTour=1&tourStep=level3-zone1`}
