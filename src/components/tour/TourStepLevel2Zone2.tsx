...
interface TourStepLevel2Zone2Props {
  onNext: () => void;
  onPrevious: () => void;
}

export function TourStepLevel2Zone2({ onNext, onPrevious }: TourStepLevel2Zone2Props) {
      ...
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        ...
        >
            ...
            <div className="mx-auto max-w-4xl">
              ...
              <div className="grid gap-6 md:grid-cols-2">
                {featuredObjects.map((obj, i) => (
                  ...
                  >
                    <Link
                      href={`${getObjectHref(obj.id)}?fromTour=1&tourStep=level2-zone2`}
          ...
          <div className="mx-auto max-w-4xl flex gap-4">
            <Link
              href={`${getZoneHref(secondZone.id)}?fromTour=1&tourStep=level2-zone2`}
