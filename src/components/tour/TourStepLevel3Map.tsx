...
interface TourStepLevel3MapProps {
  onNext: () => void;
  onPrevious: () => void;
}

export function TourStepLevel3Map({ onNext, onPrevious }: TourStepLevel3MapProps) {
        ...
        >
          <div className="mx-auto max-w-4xl">
            ...
            <p className="mb-6 text-xl leading-relaxed text-white/80">
              This map shows all zones in Level 3. Click any zone to see what is inside. Each zone explores different future possibilities for performance enhancement. You can explore zones in any order, but the tour will guide you through them.
            </p>
          </div>
