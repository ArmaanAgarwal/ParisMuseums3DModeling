...
interface TourStepLevel1EntryProps {
  onNext: () => void;
  onPrevious: () => void;
}

export function TourStepLevel1Entry({ onNext, onPrevious }: TourStepLevel1EntryProps) {
        ...
        >
          ...
          <div className="rounded-2xl border border-cyan-500/30 bg-cyan-500/10 p-8">
            ...
            <p className="mb-4 leading-relaxed text-white/90">
              Use the map on the next step to see all zones in this level. Click any zone to preview what is inside. Each zone has exhibits, and each exhibit has objects. You can explore zones in any order, but the tour will guide you through them step by step.
            </p>
            <p className="leading-relaxed text-white/90">
              As you explore, notice how objects connect to each other. Ancient equipment shows ideas that appear again in modern tools. The principles of performance optimization have not changed, only the technology.
            </p>
          </div>
